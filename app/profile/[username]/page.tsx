...
export default function PublicProfile() {
  ...
  if (notFound || !profile) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-emerald-50 flex items-center justify-center p-6">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-emerald-50 p-8">
    ...
    <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">
      {profile.about_me}
            ...
            <button
              ...
              className="mt-6 inline-flex items-center gap-2 bg-gradient-to-r from-red-600 to-pink-600 text-white px-8 py-3 rounded-2xl font-bold shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all"
            >
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            <div className="text-center p-4 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl">
              <div className="text-3xl font-black text-orange-600">{awards.length}</div>
          ...
          {profile.github_url && (
            <div className="mt-4 text-center">
               ...
               <a href={profile.github_url}
                ...
                className="inline-flex items-center gap-2 text-gray-700 hover:text-indigo-600 font-semibold"
              >
