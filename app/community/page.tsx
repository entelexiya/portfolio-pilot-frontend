...
import { Users, Search, Filter, MapPin, School, TrendingUp } from 'lucide-react'
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-16 h-16 bg-gradient-to-br from-blue-700 to-indigo-700 rounded-full flex items-center justify-center text-white text-2xl font-black">
